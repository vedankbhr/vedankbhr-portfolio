      ...
      <section className="py-12 md:py-20 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 md:gap-10">
            ...
            {/* ── PROJECT 1: Lucy ── */}
            <FadeIn delay={0.1} className="flex flex-col h-full bg-muted/30 border border-border/50 rounded-3xl hover:border-violet-500/30 hover:shadow-2xl hover:shadow-violet-500/5 transition-all duration-500 overflow-hidden group">
              <div className="p-8 pb-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  ...
                  <span className="text-xs font-medium px-2.5 py-1 bg-background border border-border/50 rounded-full flex items-center gap-1.5"><Zap className="h-3 w-3" /> Real-time</span>
            ...
            {/* ── PROJECT 2: Jonathan ── */}
            <FadeIn delay={0.2} className="flex flex-col h-full bg-muted/30 border border-border/50 rounded-3xl hover:border-blue-500/30 hover:shadow-2xl hover:shadow-blue-500/5 transition-all duration-500 overflow-hidden group">
              <div className="p-8 pb-6">
                <div className="flex items-start justify-between gap-4 mb-6">
                  <div className="flex items-center gap-4">
